...
const HistoryCard = ({
  ...
  return (
    <div
      className={`bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow duration-200 ${className}`}
    >
      {/* Date */}
      <div className="mb-3">
        <p className="text-gray-500 text-sm">{dateHistory}</p>
      </div>
